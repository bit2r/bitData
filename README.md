...
데이터셋을 번역하여 순 한글로 제공됩니다.

원본 344행의 데이터를 모두 포함하며, 일부 측정값이 누락된 관측치의 NA도
그대로 유지되어 있습니다.
